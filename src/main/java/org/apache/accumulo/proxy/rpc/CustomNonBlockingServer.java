...
public class CustomNonBlockingServer extends THsHaServer {
  ...
  /**
   * Custom wrapper around {@link SelectAcceptThread} to create our {@link CustomFrameBuffer}.
   */
  ...
  /**
   * Custom wrapper around {@link FrameBuffer} to extract the client's network location before
